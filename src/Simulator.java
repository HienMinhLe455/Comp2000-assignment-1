                ...
                for (int i = 0; i < animals.size(); i++) {
                    ...
                    if (other instanceof Caveman && other != caveman) {
                        ...
                        if (distance <= cavemanAlertRadius) {
                            ...
                            if (ally.x < dino.x) { ally.dx = Math.abs((int)ally.speed); }
                            else { ally.dx = -Math.abs((int)ally.speed); }

                            if (ally.y < dino.y) { ally.dy = Math.abs((int)ally.speed); }
                            else { ally.dy = -Math.abs((int)ally.speed); }
                        }
                    }
                }
            }
